...
The communication between index.mjs and the vault.html iframe, and between vault.html and worker.mjs, are provided by postMessage carrying jsonrpc, using [@kilroy/jsonrpc](https://github.com/kilroy-code/jsonrpc).
